...
const events = [
  {
    id: 1,
    name: "IBJJF São Paulo Open",
    date: "15 Mai 2025",
    location: "São Paulo, SP",
    venue: "Ginásio do Ibirapuera",
    status: "Confirmado",
    highlight: true,
    description: "Cobertura fotográfica e audiovisual completa do campeonato.",
  },
  {
    id: 2,
    name: "Copa Brasil de Jiu-Jitsu",
    date: "28 Jun 2025",
    location: "Rio de Janeiro, RJ",
    venue: "Riocentro Pavilhão 4",
    status: "Confirmado",
    highlight: false,
    description: "Fotografia oficial do evento com entrega em 48h.",
  },
  {
    id: 3,
    name: "IBJJF World Championship",
    date: "12 Jul 2025",
    location: "Long Beach, CA — EUA",
    venue: "Long Beach Arena",
    status: "Confirmado",
    highlight: false,
    description: "Cobertura do maior campeonato de jiu-jitsu do mundo.",
  },
  {
    id: 4,
    name: "Grand Slam — Rio 2025",
    date: "09 Ago 2025",
    location: "Rio de Janeiro, RJ",
    venue: "Arena Carioca 1",
    status: "Aguardando confirmação",
    highlight: false,
    description: "Etapa brasileira do Grand Slam IBJJF.",
  },
];
